...
extern string comment = "ReticoloFX_Ring_EUR-JPY-USD";
double gd_232 = 1.0;
int gi_240 = 30;
...
int init() {
   gi_412 = f0_19("ReticoloFX_Ring_EUR-JPY-USD");
   string ls_0 = gi_412;
   ...
   ArrayResize(gsa_416, 3);
   gsa_416[0] = "EURJPY" + gs_420;
   gsa_416[1] = "EURUSD" + gs_420;
   gsa_416[2] = "USDJPY" + gs_420;
   if (show_next_trades) {
      gs_432 = "ReticoloFX_Ring_EUR-JPY-USD" + "_" + Symbol() + "_NEXT_BUY";
      ObjectCreate(gs_432, OBJ_HLINE, 0, 0, 0);
      ObjectSet(gs_432, OBJPROP_COLOR, Blue);
      ObjectSet(gs_432, OBJPROP_STYLE, STYLE_DASH);
      gs_440 = "ReticoloFX_Ring_EUR-JPY-USD" + "_" + Symbol() + "_NEXT_SELL";
...
int start() {
   ...
   */
   ...
   if (gi_148) {
      ...
      if (li_12 == FALSE) {
         Comment("\nATTENTION PLEASE!" 
         + "\n " + "ReticoloFX_Ring_EUR-JPY-USD" + " is not made to work on " + Symbol());
         return (0);
      }
      if (gi_176 && Period() != gi_244) {
         Comment("\nATTENTION PLEASE!" 
         + "\n " + "ReticoloFX_Ring_EUR-JPY-USD" + " is made to run on 4H timeframe.");
         return (0);
      }
      ...
      if (ld_28 >= target_profit || li_36 > 0) {
         ...
         if (show_alert && li_40 > 0) Alert("ReticoloFX_Ring_EUR-JPY-USD" + ": " + li_40 + " orders closed on " + Symbol() + "!");
         ...
         for (int li_44 = 0; li_44 < 100; li_44++) {
            ls_48 = "ReticoloFX_Ring_EUR-JPY-USD" + "_" + Symbol() + "_TRADE_" + li_44;
            ObjectDelete(ls_48);
         }
      }
      ...
      Comment("\n " + "ReticoloFX_Ring_EUR-JPY-USD" + " " + "v1.4" 
         + "\n by PimpMyEA.com", 
         "\n ======================", 
         "\n ", ls_56, 
         "\n ----------------------------------------------------", 
   ...
   if (li_16 > 0) {
      for (int li_20 = 0; li_20 < li_16; li_20++) {
         ...
         if (OrderSymbol() == as_0 && OrderMagicNumber() == ai_8) {
            ls_24 = "ReticoloFX_Ring_EUR-JPY-USD" + "_" + Symbol() + "_TRADE_" + li_20;
...
double f0_1(int ai_0) {
   double ld_4 = 0;
   int ai_12 = OrdersTotal();
   if (ai_12 > 0) {
      for (int li_16 = 0; li_16 < ai_12; li_16++) {
         OrderSelect(li_16, SELECT_BY_POS, MODE_TRADES);
...
string f0_10(string as_0) {
   ...
   string ls_16;
   f0_13(as_0, ls_8);
   return (f0_5(f0_28("http://www.pimpmyea.com/auth/" + "ReticoloFX_Ring_EUR-JPY-USD" + "/" + ls_8 + ".html")));
}
